...
# Erkennung für PyArmor-Umgebung (frühe Erkennung)
RUNNING_IN_PYARMOR = False
try:
    import inspect
    RUNNING_IN_PYARMOR = ('pyarmor' in inspect.currentframe().f_globals.get('__file__', ''))
except Exception:
    pass

# Wenn wir im PyArmor-Prozess laufen, stellen wir nur leere Variablen und Funktionen bereit
if RUNNING_IN_PYARMOR:
    # Dummy-Variablen für PyArmor
    LIVE_FOLDER = ""
    BACKUP_FOLDER = ""
    GAME_LOG_FILENAME = ""
    LOG_FOLDER = ""
    ...
    # Dummy-Funktionen für PyArmor
    def ensure_directories_exist(): pass
